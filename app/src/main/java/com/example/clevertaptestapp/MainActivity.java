...
{
    public Button btn, bt, b,c,A,sg, sg1,sg2,nxt;
...
//        CleverTapAPI.getDefaultInstance(this).pushNotificationViewedEvent(null);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                profileUpdate.put("Email", "shikha@clevertap.com"); // Email address of the user
        ...
        bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                profileUpdate.put("Email", "adarsh911verma@gmail.com");               // Email address of the user
